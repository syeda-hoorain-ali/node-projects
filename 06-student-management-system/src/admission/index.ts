...
import { Student, titleCase, sleep, students, updateStudents } from '../utils.js';
...
const newAdmission = async () => {
    ...
    updateStudents(students); // Update the students data with new student
    await mainStudents(); // Call main function for student management
}
