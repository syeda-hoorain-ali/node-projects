...
export const deleteTask = async (tasks, todo) => {
...
export const displayTasks = (todo) => {
...
export const toggleCompletedTasks = async (tasks, todo) => {
...
export const getTaskNames = (todo) => {
